...
module Yardstick
  module Rules
    ...
    class Summary
      ...
      #
      class Presence < Rule
        describe '*method summary* should be specified'
      ...
      class Length < Rule
        ...
        describe '*method summary* should be less than or equal to 79 characters in length'
      ...
      class Delimiter < Rule
        describe '*method summary* should not end in a period'
      ...
      class SingleLine < Rule
        ...
        describe '*method summary* should be a single line'
